...
public class CustomerController {
    ...
    // Evaluation Form 18
    // Building a controller and service layers that contain a list of all the animals that the animal owner with the corresponding ID number has registered in the system
    ...
    // Evaluation Form 10
    // Establishing the controller and service layers required for the registration of animal owners
    @PostMapping("/create")
